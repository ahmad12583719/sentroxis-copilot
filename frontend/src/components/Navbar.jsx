import { Bell, CircleHelp, Command, LogOut, Menu, Search, ShieldCheck } from 'lucide-react'

const navItems = [
  { label: 'Server setup', key: 'setup' },
